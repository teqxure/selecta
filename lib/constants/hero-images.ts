/**
 * Curated decorative imagery for the marketplace hero — sourced from
 * Pexels (Pexels License: free for commercial use, no attribution
 * required, https://www.pexels.com/license/). Not user-uploaded content
 * and not tied to any real listing, so it's blended with real catalog
 * photos in the hero rather than presented as an actual product.
 */
