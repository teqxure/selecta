...
import { submitRiderPersonalInfoAction, type RiderOnboardingActionState } from "./actions";
...
export function RiderOnboardingPersonalForm({
  defaultFirstName,
  defaultLastName,
  defaultPhone,
}: {
  ...
  const [state, formAction] = useActionState(submitRiderPersonalInfoAction, initialState);
