...
export default async function AdminSellersPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-2xl font-semibold text-foreground">Sellers ({totalCount})</h1>
            ...
            <tbody>
              {sellers.map((seller) => (
                <tr key={seller.id} className="border-b border-border last:border-0">
                  <td className="px-4 py-3 text-secondary-foreground">{seller.storeName ?? seller.businessName}</td>
